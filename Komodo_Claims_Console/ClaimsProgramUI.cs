...
namespace Komodo_Claims_Console
{
    class ClaimsProgramUI
    {
        ...
        private void SeedClaimsList()
        {
            ...
            Claims claimTwo = new Claims(2, ClaimType.Home, "House fire in kitchen", 4000.00m, new DateTime(2018, 04, 11), new DateTime(2018, 04, 12));
            Claims claimThree = new Claims(3, ClaimType.Theft, "Stolen pancakes", 4.00m, new DateTime(2018, 04, 27), new DateTime(2018, 06, 01));
